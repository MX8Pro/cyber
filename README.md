...
3. **استخدم نفس كلمة السر المنطقية**
   - النظام يدعم الآن اختلافات الإدخال الشائعة (مسافات زائدة، محارف غير مرئية، واختلاف شكل الأرقام العربية/الإنجليزية)، لكن يبقى الأصل أن الكلمة نفسها صحيحة.
4. **تأكد أن التفعيل لم ينتهِ**
   - التفعيل المحلي له صلاحية زمنية. بعد انتهاء المدة يلزم دخول واحد بالإنترنت لإعادة التفعيل.
5. **إذا غيّرت كلمة السر من الإدارة**
...
- **انتهاء صلاحية الجهاز الموثوق**
  - الحل: إعادة التفعيل بالإنترنت.
...
- [ ] لا أستخدم Incognito.
- [ ] كلمة السر الحالية لم تتغير منذ آخر تفعيل.
